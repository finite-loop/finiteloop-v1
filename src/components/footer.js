      ...
      >
        ...
        <a href="https://reactjs.org/" target="_new">
          <img
            alt="ReactJS"
            height="40"
            src="https://codebrahma.com/wp-content/uploads/2017/04/ReactLogo-HD-01-e1491298246346.png"
          />
        </a>
        <a href="https://material-ui-next.com/" target="_new">
          <img
            alt="Material UI"
            height="40"
            src="https://material-ui-next.com/static/images/material-ui-logo.svg"
          />
        </a>
        <a
          href="https://github.com/partha360/finiteloop-gatsby-netlifyCMS-ReactJS"
          target="_new"
        >
          <img
            alt="Source"
        ...
        <a href="https://www.netlifycms.org/" target="_new">
          <img
            alt="Netlify CMS"
            height="40"
            src="https://d33wubrfki0l68.cloudfront.net/1f4ce04369d08e4f8c3a7ca30a11c4873fda2ae1/19979/img/netlify-cms-logo.svg"
          />
        </a>
      </div>
      <div className={classes.root}>
        ...
        <a href="https://www.netlify.com/" target="_new">
          <img
            alt="Netlify CMS"
            src="https://cdn.netlify.com/534ab499b9c56e50ea3fc1558b5edffa6d7117f5/2d930/img/press/logos/full-logo-dark.svg"
          />
        </a>
      </div>
